...
const FEED_LINK = 'https://bsky.app/profile/crowdedteeth.bsky.social/feed/bushwick';
  ...
  return (
    <div>
      ...
      <p>
        ...
        example, posts which promote local events, community-owned businesses, or Bushwick-related
        news are of principal interest. Secondarily, we aim to cultivate conversation among members
        of our community by highlighting "hot"/"trending" posts pertaining to any aspect of
        Bushwick's diverse culture.
        <br />
        <br />
        Practically, this means that posts are often added ad hoc by replying with the&nbsp;
        <code>#bushwickfeed</code>&nbsp;tag when they meet the criteria. Subscribers of the feed are
        encouraged to use this tag to promote their own posts as well as applicable content they
        encounter in the wild!
        <br />
        <br />
        Certain fixtures of the Bushwick community (e.g., Bushwick Daily) are allowlisted to include
        all their posts in the feed. If you have a suggestion for a new allowlisted account, please
        suggest it below!
        <br />
        <br />
        Do reach out to{' '}
